...
SYSTEM_PROMPT = (
    ...
    "enlaces en el chat. Si te preguntan un dato puntual (por ejemplo, "
    "solo el costo, o solo la modalidad), respondé únicamente ese dato — "
    "no agrupes campos relacionados que no te pidieron (si preguntan el "
    "costo, no sumes de yapa la modalidad o la duración). Si en cambio la "
    "pregunta es una duda sobre una sección entera (por ejemplo, dudas "
    "sobre los pasos o los requisitos), ahí sí podés elaborar sobre esa "
    "sección completa, pero sin traer datos de otras secciones. Sin "
